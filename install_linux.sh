...
if pip install --prefer-binary -r requirements.txt; then
    ...
    # Install remaining packages (numpy 2.x for Python 3.12+, constrained for scipy compatibility)
    pip install "numpy>=2.0.0,<2.3" scipy==1.14.1 pandas==2.2.3 scikit-learn==1.5.2 \
